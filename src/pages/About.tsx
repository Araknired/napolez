  ...
  <div className="fixed inset-0 bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center z-50">
    <div className="relative w-32 h-32">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-32 h-32 border-8 border-purple-200 rounded-full" />
      </div>
...
const StarRating: FC = () => (
  <div className="flex items-center gap-3 pt-4">
    ...
    <span className="text-gray-900 font-semibold text-base lg:text-lg">{RATING_VALUE}</span>
    <span className="text-gray-500 text-sm lg:text-base">({REVIEW_COUNT})</span>
  </div>
);
...
const HeroImage: FC<HeroImageProps> = ({ isVisible }) => (
  <div className={`relative order-1 lg:order-2 transition-all duration-700 delay-200 ${
    ...
    <div className="absolute top-0 right-0 w-64 h-64 lg:w-96 lg:h-96 bg-purple-200 rounded-full blur-3xl opacity-30" aria-hidden="true" />
    <div className="absolute bottom-0 left-0 w-56 h-56 lg:w-80 lg:h-80 bg-blue-200 rounded-full blur-3xl opacity-30" aria-hidden="true" />
