...
export default function About() {
    ...
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center z-50">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-32 h-32 border-8 border-transparent border-t-purple-600 rounded-full animate-spin"></div>
          </div>
  ...
  return (
    <section className="relative bg-gradient-to-br from-purple-50 via-white to-blue-50 min-h-screen flex items-center overflow-hidden pt-20 lg:pt-0">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12 lg:py-20 w-full">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className={`space-y-6 lg:space-y-8 order-2 lg:order-1 transition-all duration-700 ${
            ...
            <p className="text-gray-600 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl">
              This project is part of a practical demonstration to showcase my skills in React, Vite, Tailwind CSS, and TypeScript, among other technologies. I'm grateful to the organizations and resources that contributed to the knowledge gained during its development.
            </p>
            ...
            <div className="flex items-center gap-3 pt-4">
              <div className="flex">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg key={star} className="w-5 h-5 lg:w-6 lg:h-6 text-yellow-400 fill-current" viewBox="0 0 24 24">
                    <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/>
                  </svg>
                ))}
              </div>
              <span className="text-gray-900 font-semibold text-base lg:text-lg">4.9</span>
              <span className="text-gray-500 text-sm lg:text-base">(54)</span>
            </div>
            
            <p className="text-sm lg:text-base text-gray-500">Trusted software reviewed!</p>
          </div>
          ...
          <div className={`relative order-1 lg:order-2 transition-all duration-700 delay-200 ${
            ...
            <div className="absolute top-0 right-0 w-64 h-64 lg:w-96 lg:h-96 bg-purple-200 rounded-full blur-3xl opacity-30"></div>
            <div className="absolute bottom-0 left-0 w-56 h-56 lg:w-80 lg:h-80 bg-blue-200 rounded-full blur-3xl opacity-30"></div>
            
            <div className="relative">
              <img 
                src={robotImage} 
                alt="AI Robot Marketing" 
              ...
              <div className="absolute top-8 sm:top-12 -right-2 sm:right-0 bg-white rounded-full p-2 sm:p-3 lg:p-4 shadow-xl z-20">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className={`mt-12 lg:mt-20 bg-black rounded-2xl lg:rounded-3xl py-6 lg:py-10 px-4 lg:px-8 transition-all duration-700 delay-300 ${
          showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
          <div className="flex flex-wrap justify-center lg:justify-around items-center gap-6 lg:gap-8">
            {[
              ...
              >
                <org.icon className="text-3xl lg:text-5xl" />
                <span className="text-lg lg:text-2xl font-semibold">{org.name}</span>
              </div>
            ))}
          </div>
        </div>
