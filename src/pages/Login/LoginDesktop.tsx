...
export default function LoginDesktop() {
  ...
  return (
    <div className="hidden lg:flex h-screen pt-20 overflow-hidden bg-white">
      {/* Left Side - Image */}
      <div 
        className={`lg:w-1/2 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-16 flex items-center justify-center relative overflow-hidden transition-all duration-1000 ${
          pageLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'
        }`}
      >
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-32 -right-32 w-96 h-96 bg-gradient-to-br from-blue-300 to-purple-300 rounded-full blur-3xl opacity-20 animate-blob"></div>
          <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-gradient-to-br from-purple-300 to-pink-300 rounded-full blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-br from-pink-300 to-blue-300 rounded-full blur-3xl opacity-10 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center max-w-2xl">
          ...
          >
            ...
            <div className="text-center">
              <h2 className={`text-5xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent mb-4 transition-all duration-1000 ${
              ...
              style={{ transitionDelay: '300ms' }}>
                Explore amazing features and discover excellence
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute top-20 left-20 w-24 h-24 bg-blue-200 rounded-full opacity-20 blur-xl animate-pulse"></div>
        ...
        <div className="relative z-10 max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            >
              ...
              <div className={`relative bg-white rounded-2xl overflow-hidden transition-all duration-300 ${
                focusedField === 'email' 
                  ? 'shadow-xl shadow-blue-500/20 border-2 border-blue-500' 
            ...
            >
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  className="w-5 h-5 text-blue-500 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 cursor-pointer"
                />
            ...
            >
              <button
                type="submit"
                disabled={loading}
                className="w-full relative overflow-hidden group rounded-2xl font-semibold text-lg text-white transition-all duration-300 shadow-xl shadow-green-500/30 hover:shadow-2xl hover:shadow-green-500/40 hover:scale-[1.02] active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-green-500 via-green-600 to-emerald-600 transition-all duration-300"></div>
                ...
                <div className="relative px-6 py-4 flex items-center justify-center gap-2">
                  {loading ? (
                    <>
                      ...
                      <span className="text-white">{isPhone(emailOrPhone) ? 'Sending code...' : 'Signing in...'}</span>
                    </>
          ...
          >
            <button
              ...
              disabled={loading}
              className="w-16 h-16 flex items-center justify-center rounded-2xl border-2 border-gray-200 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 bg-white hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-110"
            >
