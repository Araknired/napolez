        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {registrationType === 'phone' ? (
            ...
            >
              ...
              <input
                ...
                className="w-full px-0 py-2 bg-transparent border-0 border-b-2 border-gray-200 focus:border-green-400 focus:outline-none focus:ring-0 text-gray-900 placeholder-gray-400 transition-colors"
          ...
          >
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-sm text-gray-600">
                Agree with{' '}
                <Link to="/terms" className="text-blue-400 hover:text-blue-500 font-medium">
                  Terms & Condition
                </Link>
              </span>
            </label>
          ...
          >
            <button
              ...
              style={{
                background: registrationType === 'email' 
