      ...
      <div className="relative z-10 px-6 md:px-16 md:pt-16 flex flex-col md:flex-row items-center justify-between min-h-screen">
        ...
        <div className="w-full md:w-[42%] space-y-6 md:space-y-10 md:-mt-8 order-2 md:order-1 pb-8 md:pb-0 -mt-8">
          ...
          >
            ...
            <span className="text-base md:text-xl">Personas probaron</span>
          </div>
          ...
          >
            <p className="text-white/90 text-base md:text-xl leading-relaxed max-w-[85%] md:max-w-lg">
              Disfruta de la mejor bebida de todos los tiempos, patrocinado por los mayores consumidores de crack y mota de este país.
            </p>
          </div>
          ...
          {/* Product Carousel Navigation - Desktop horizontal, Mobile vertical */}
          <div 
        ...
        {/* Right Content Section - Hero Product Display */}
        <div className="w-full md:w-[58%] flex items-center justify-center relative h-[50vh] md:h-full order-1 md:order-2 mt-16 md:mt-0">
          ...
          {/* Mobile Horizontal Navigation - Sides of Logo */}
