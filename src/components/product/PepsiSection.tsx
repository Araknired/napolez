...
const PepsiSection = () => {
  ...
  return (
    <div className={`min-h-screen ${bgGradient} relative overflow-hidden`}>
      ...
      <button
        onClick={toggleTheme}
        className={`fixed top-6 right-6 z-50 p-3 rounded-full ${isDark ? 'bg-white/10 hover:bg-white/20' : 'bg-gray-200 hover:bg-gray-300'} backdrop-blur-md border-2 ${isDark ? 'border-white/20' : 'border-gray-300'} transition-all duration-300 shadow-lg hover:scale-110 active:scale-95`}
